...
helm.sh/chart: {{ include "nginx-private.chart" . }}
...
*/}}
{{- define "nginx-private.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "nginx-private.fullname" .) .Values.serviceAccount.name }}
{{- else }}
